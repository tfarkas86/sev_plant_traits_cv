...
## Input raw data
  ab.raw <- read_csv("~/Dropbox/Projects/Sev/Plants/sev_traits_cv_manuscript/Data/Sevilleta_allbiomass_28Jan2018.csv", 
...
temp_cv_quad <- ab %>%
  ...
  # gather metrics of bounciness
  gather(key="bounce_type", value="bounce", cv, q1090)
```
...
save(temp_wide, file = "~/Dropbox/Projects/Sev/Plants/sev_traits_cv_manuscript/Data/raw_bounce_wide.RData")
